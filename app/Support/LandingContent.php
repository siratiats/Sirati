...
class LandingContent
{
    ...
    private array $content = [
        ...
        'hero.preview_brand' => ['ar' => 'سيرتي ATS', 'en' => 'Sirati ATS'],
        'hero.preview_score' => ['ar' => 'درجة السيرة', 'en' => 'CV Score'],
        'hero.preview_keywords' => ['ar' => 'الكلمات المفتاحية', 'en' => 'Keywords'],
        'hero.preview_keywords_status' => ['ar' => 'جيد', 'en' => 'Good'],
        'hero.preview_experience' => ['ar' => 'الخبرة', 'en' => 'Experience'],
        'hero.preview_experience_status' => ['ar' => 'تحتاج تحسين', 'en' => 'Improve'],
        'hero.preview_format' => ['ar' => 'تنسيق ATS', 'en' => 'ATS format'],
        'hero.preview_format_status' => ['ar' => 'جاهز', 'en' => 'Ready'],
        'hero.preview_template_title' => ['ar' => 'قالب ذكي', 'en' => 'Smart template'],
        'hero.preview_template_body' => ['ar' => 'تنسيق واضح وجاهز لمسؤولي التوظيف وأنظمة الفرز.', 'en' => 'Clean layout ready for recruiters and screening systems.'],
